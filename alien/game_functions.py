...
def check_play_button(stats, play_button, mouse_x, mouse_y, aliens, bullets, ship, screen,
                      ai_settings, sb):
...
def check_events(ai_settings, screen, ship, bullets, stats, play_button, aliens, sb):
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            check_play_button(stats, play_button, mouse_x, mouse_y, aliens, bullets, ship, screen,
                              ai_settings, sb)
